...
export default function SuccessPage() {
  ...
  const ref = params.get("ref") || Math.random().toString(36).substr(2, 8).toUpperCase();
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-green-400">{postiAuto}</p>
            </div>

            <div>
              <p className="text-xs text-gray-400 mb-1">Location cena</p>
              <p className="text-sm font-medium">Villa Tre Colli · Ariano Irpino</p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <p className="text-sm text-gray-300 leading-relaxed">
              ...
              Dopo cena potrai raggiungere l’Eclipse Noir con i <strong>posti auto riservati e garantiti</strong> per la tua prenotazione.
            </p>
